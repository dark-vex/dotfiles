...
💡 - [Learn how to build your own dotfiles](https://github.com/dark-vex/dotfiles#your-own-dotfiles)

If you find this repo useful, [consider sponsoring me](https://github.com/sponsors/dark-vex) (a little bit)! ❤️ 
...
2. Setup an SSH key by using one of the two following methods  
   ...
   ```zsh
   curl https://raw.githubusercontent.com/dark-vex/dotfiles/HEAD/ssh.sh | sh -s "<your-email-address>"
   ```

3. Clone this repo to `~/.dotfiles` with:

    ```zsh
    git clone --recursive git@github.com:dark-vex/dotfiles.git ~/.dotfiles
    ```
